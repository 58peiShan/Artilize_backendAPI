...
(89, '66', '2022-06-07 21:18:22', '<p>66666666666666666666666666666666666666666666666666666666666666</p>', 0, 1, 5),
(90, '5555555555555555555', '2022-06-07 21:22:01', '<p>555555555555555555555555555555555555555555555555555555555</p>', 0, 1, 5);
...
CREATE TABLE `blog_category` (
  ...
  `thema` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `blog_comment` (
  ...
  `Blog_comment_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
...
(4, '', '1654568234657.jpg', '1654568234667.png', '2022-06-07 00:00:00', '2022-06-07 00:00:00', '2022-06-07 02:17:14', '132', 1, 1, 1),
(5, '', '1654568273287.jpg', '1654568273297.png', '2022-06-07 00:00:00', '2022-06-07 00:00:00', '2022-06-07 02:17:53', '132', 1, 1, 1),
(6, '', '1654568280109.jpg', '1654568280120.png', '2022-06-07 00:00:00', '2022-06-07 00:00:00', '2022-06-07 02:18:00', '132', 1, 1, 1),
(7, '', '1654568303728.jpg', '1654568303737.png', '2022-06-07 00:00:00', '2022-06-07 00:00:00', '2022-06-07 02:18:23', '132', 1, 1, 1),
(8, '', '1654568387926.jpg', '1654568387938.png', '2022-06-07 00:00:00', '2022-06-07 00:00:00', '2022-06-07 02:19:48', '132', 1, 1, 1),
(9, '', '1654568444696.jpg', '1654568444705.png', '2022-06-07 00:00:00', '2022-06-07 00:00:00', '2022-06-07 02:20:44', '132', 1, 1, 1);
...
CREATE TABLE `exhibition_city` (
  ...
  `city` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '城市Name',
...
CREATE TABLE `exhibition_direction` (
  `id` int NOT NULL COMMENT '主鍵',
  `direction` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT '地區分類Name'
...
CREATE TABLE `exhibition_kind` (
  ...
  `kind` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT '活動展覽類型'
...
INSERT INTO `exhibition_museum` (`mid`, `mName`, `ddress`, `longitude`, `latitude`) VALUES
...
CREATE TABLE `product_main` (
  ...
  `product_introduce` varchar(10000) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'product_introduce',
...
CREATE TABLE `users` (
  ...
  `userPassword` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
...
(5, 'a860505', 'qwertQQ!123456', 'a_860505@hotmail.com', '蕭宏玉', '0912856147', '', '宏', 'user11.png', '2009-05-05', 0, '2022-03-21 09:31:42'),
(6, 'maxine0509', '~A123JEIFJIOALzzz', 'maxine_0509@gmail.com', '黃子蕊', '0919007893', '宜蘭縣大同鄉南山村泰雅路七段220號', '半吊子文青', 'user10.png', '1996-06-27', 1, '2022-03-18 17:29:50'),
(7, 'jason1230301', 'OALsss01~', 'jasonwww@yahoo.com.tw', '黃傑森', '', '', 'Jason', 'user9.png', '1992-07-18', 0, '2022-03-18 16:06:10'),
...
(9, 'toyzzz22', 'Abc123+', 'toyzzz22@gmail.com', '李俊傑', '0932283859', NULL, 'Josh', 'user2.png', NULL, NULL, '2022-06-07 15:22:26'),
(10, 'FRFR5588', 'bbC_58', 'fr_5588@gmail.com', '', '', NULL, '玖仈', 'user3.png', NULL, NULL, '2022-06-07 15:22:26'),
(11, 'toyzzz88', 'bbC_5777', '22@gmail.com', '黃怡', '0975997685', '台東縣台東市建興里知本路四段2號', 'PinkDemon', 'user4.png', '2022-03-25', 0, '2022-03-14 10:32:23'),
...
(13, 'wwcatieww', 'kldfv5+A', 'catiewww@hotmail.com', '', '', '', '布魯', 'user6.png', '2022-03-02', 0, '2022-03-14 16:18:57'),
...
--
ALTER TABLE `blog_comment`
  MODIFY `blog_comment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `exhibition_actadm`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT '主鍵', AUTO_INCREMENT=10;
